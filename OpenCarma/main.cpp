...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        // Texture loader
        CarmaTextureLoaderPtr carmaLoader(new CarmaTextureLoader());
        ...
        //OpenCarma::Render::StaticModelNodePtr node(new OpenCarma::Render::StaticModelNode(mdl));
        //rootNode->attachChild(std::dynamic_pointer_cast<Commons::Render::RenderNode>(node));
        //node->setTranslation(glm::translate(0.F, 0.F, 0.F));
